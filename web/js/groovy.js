var messages = {
  pipeanomally:
    "This Pipe Number was already taken.Are you Sure want to override?",
  ...
  oops: "Oops!",
  kpRangeWarning:
    "KP has not been cleared. Please submit Clear & Grade report first",
  outcomeWarning:
    "Cutting Out this Weld will remove it from the system.\n Are you sure?",
};
  ...
  var callTry = function (data, callback) {
    ...
    $.ajax(ajxOpts)
      ...
      .fail(function (r) {
        $(".pjax-loader").hide();
        toastr.error(
          "Your server request has been failed :" + baseurl + data.url,
          messages.oops
        );
      });
  };
...
var getLandowner = function (start, end) {
  _before_html =
    '<span class="text-center landowner-loader"><i class="fa fa-spin fa-spinner fa-2x"></i></span>';
  $(".landowner-details").html(_before_html);
  call(
    {
      url: "pipe/pipe-cleargrade/landowner",
    ...
    function (resp) {
      if (resp.status) {
        ...
        $(".landowner-details").html(
          '<h4 class="text-center">No Landowner Available Now</h4>'
        );
      }
    }
  );
...
var _ini = function () {
  ...
  $(document).on("click", ".addField", function (e) {
    ...
    call(
      { url: "pipe/default/add-defect-field", params: {}, type: "GET" },
      function (resp) {
  ...
  $(document).on("click", ".addFieldNdt", function (e) {
    ...
    call(
      { url: "welding/default/get-ndt-field", params: {}, type: "GET" },
      function (resp) {
        $(".field-holder").append(resp.html);
  ...
  var getPipeDefect = function (PipeNumber) {
    call(
      {
        url: "pipe/default/getdefectfield",
        params: { PipeNumber: PipeNumber },
        type: "GET",
      },
      function (resp) {
  ...
  $(".auto-pipe").autocomplete({
    ...
    source: function (request, response) {
      call(
        {
          url: "pipe/default/pipe-auto-list",
          params: { pipe_number: request.term },
          type: "GET",
        },
        function (resp) {
          response(
    ...
    select: function (event, ui) {
      ...
      if ($("#cutting-length").length > 0) {
        ...
        if (ui.item.value.pipe_number) {
          call(
            {
              url: "pipe/cutting/get-new-pipes",
              params: { pipe_number: ui.item.value.pipe_number },
              type: "POST",
            },
            function (resp) {
              if (resp.status) {
  ...
  $(".auto-pipe-from-reception").autocomplete({
    ...
    source: function (request, response) {
      call(
        {
          url: "pipe/default/pipe-auto-list-for-stringing",
          params: {
            pipe_number: request.term,
            location: $("#stringing-location").val(),
          },
          type: "GET",
        },
        function (resp) {
  ...
  $(".auto-pipe-for-bending").autocomplete({
    ...
    source: function (request, response) {
      call(
        {
          url: "pipe/default/pipe-auto-list-for-bending",
          params: { pipe_number: request.term },
          type: "GET",
        },
        function (resp) {
  ...
  $(".auto-pipe-from-stringing").autocomplete({
    ...
    source: function (request, response) {
      call(
        {
          url: "pipe/default/pipe-auto-list-for-welding",
          params: {
            pipe_number: request.term,
            kp: $(".weld-kp").val(),
            next: "no",
  ...
  $(".drum_number").autocomplete({
    source: function (request, response) {
      ...
      call(
        {
          url: "cabling/default/auto-list",
          params: { drum_number: request.term },
          type: "GET",
        },
        function (resp) {
          response(
  ...
  $(".splice_drum_number").autocomplete({
    source: function (request, response) {
      ...
      call(
        {
          url: "cabling/default/auto-list",
          params: { drum_number: request.term, fromStringing: 1 },
          type: "GET",
        },
        function (resp) {
          response(
  ...
  $(".taxo-loc-picker-container").locationpicker({
    ...
    radius: 300,
    zoom:
      typeof _taxo_lat != "undefined" && typeof _taxo_long != "undefined"
        ? 12
        : 5,
    inputBinding: {
  ...
  $(".weld-number-auto").autocomplete({
    ...
    source: function (request, response) {
      ...
      var kp_value =
        typeof $(".parameter-kp").val() != "undefined"
          ? $(".parameter-kp").val()
          : "";
      ...
      call(
        {
          url: "welding/default/auto-weld-number",
          params: { weld_number: request.term, kp: kp_value },
          type: "GET",
        },
        function (resp) {
          response(
  ...
  $(".trenching-auto").autocomplete({
    ...
    source: function (request, response) {
      ...
      call(
        {
          url: "welding/default/civil-weld-number",
          params: {
            weld_number: request.term,
            kp: kp_value,
            action: "Trenching",
            type: _type,
          },
  ...
  $(".cathodic-auto").autocomplete({
    ...
    source: function (request, response) {
      ...
      call(
        {
          url: "welding/default/precom-weld-number",
          params: {
            weld_number: request.term,
            kp: kp_value,
            action: "Cathodic",
  ...
  $(".ndt-reject-weld").autocomplete({
    ...
    source: function (request, response) {
      ...
      call(
        {
          url: "welding/default/ndt-reject-weld",
          params: { weld_number: request.term, kp: kp_value },
          type: "GET",
        },
        function (resp) {
    ...
    select: function (event, ui) {
      ...
      call(
        {
          url: "welding/default/get-weld-data",
          params: {
            number: ui.item.value.weld_number,
            kp: $(".parameter-kp").val(),
          },
          type: "POST",
        },
        function (resp) {
          var _weld_type =
            typeof resp.data.weld_type !== "undefined"
              ? resp.data.weld_type
              : "";
          var _weld_sub_type =
            typeof resp.data._weld_sub_type !== "undefined"
              ? resp.data._weld_sub_type
              : "";
          _html =
            '<div class="form-group field-parameter-wps clearfix">\
                    <div class="col-md-12 clearfix">\
                        <label class="control-label" for="parameter-wps">Weld Type</label>\
                        <input type="text" disabled id="parameter-wps" class="form-control" name="Parameter[wps]" value="' +
            _weld_type +
            '">\
                    </div>\
                </div>';
      ...
      call(
        {
          url: "welding/weldingrepair/get-ndt-data",
          params: {
            number: ui.item.value.weld_number,
            kp: $(".parameter-kp").val(),
          },
        ...
        function (resp) {
          var report_number =
            typeof resp.data.report_number !== "undefined"
              ? resp.data.report_number
              : "";
          var ndt_defects =
            typeof resp.data.ndt_defects !== "undefined"
              ? resp.data.ndt_defects
              : "";
          var ndt_defect_position =
            typeof resp.data.defect_position !== "undefined"
              ? resp.data.defect_position
              : "";
  ...
  var getNdtHtml = function (weldnumber, section = "") {
    call(
      {
        url: "welding/default/get-ndt-field",
        params: { weld_number: weldnumber, section: section },
        type: "GET",
      },
      function (resp) {
  ...
  $(".parameter-weld").autocomplete({
    ...
    source: function (request, response) {
      ...
      call(
        {
          url: "welding/default/auto-weld-number-from-param",
          params: { weld_number: request.term, kp: kp_value },
          type: "GET",
        },
        function (resp) {
      ...
      var html =
        '<div class="form-group field-parameter-wps clearfix">\
                    <div class="col-md-6 col-sm-6 clearfix">\
                        <label class="control-label" for="parameter-wps">Weld Type</label>\
                        <input type="text" disabled id="weld_type" class="form-control" name="Parameter[wps]" value="' +
        ui.item.value.weld_type +
        '">\
                    </div>\
                    <div class="col-md-6 col-sm-6 clearfix">\
                        <label class="control-label">Weld Sub Type</label>\
                        <input type="text" disabled id="weld_sub_type" class="form-control" name="Parameter[wps]" value="' +
        ui.item.value.weld_sub_type +
        '">\
                    </div>\
                </div>';
      $(".weld-type").html(html);
  ...
  $(".production-weld").autocomplete({
    ...
    source: function (request, response) {
      ...
      call(
        {
          url: "welding/default/auto-weld-number-from-ndt",
          params: { weld_number: request.term, kp: kp_value },
          type: "GET",
        },
        function (resp) {
      ...
      var html =
        '<div class="form-group field-production-wps clearfix">\
                    <div class="col-md-6 col-sm-6 clearfix">\
                        ...
                        <input type="text" disabled id="weld_type" class="form-control" name="Production[weld_type]" value="' +
        ui.item.value.weld_type +
        '">\
                    </div>\
                    <div class="col-md-6 col-sm-6 clearfix">\
                        <label class="control-label" for="production-wps">Weld Sub Type</label>\
                        <input type="text" disabled id="weld_sub_type" class="form-control" name="Production[weld_sub_type]" value="' +
        ui.item.value.weld_sub_type +
        '">\
                    </div>\
                </div>';
  ...
  $(".coatingrepair-weld").autocomplete({
    ...
    source: function (request, response) {
      ...
      call(
        {
          url: "welding/default/auto-weld-number-from-production",
          params: { weld_number: request.term, kp: kp_value },
          type: "GET",
        },
        function (resp) {
  ...
  $(".from-kp-land").autocomplete({
    ...
    source: function (request, response) {
      call(
        {
          url: "admin/landowner/get-kp-list",
          params: { kp: request.term, state: "from_kp" },
          type: "POST",
        },
        function (resp) {
          response(
  ...
  $(".to-kp-land").autocomplete({
    ...
    source: function (request, response) {
      call(
        {
          url: "admin/landowner/get-kp-list",
          params: { kp: request.term, state: "to_kp" },
          type: "POST",
        },
        function (resp) {
          response(
  ...
  $(".auto-vehicle-number").autocomplete({
    ...
    source: function (request, response) {
      call(
        {
          url: "vehicle/default/vehicle-auto-list",
          params: { vehicle_number: request.term },
          type: "GET",
        },
        function (resp) {
          response(
  ...
  var getVehiclePartList = function (_vehicle_id) {
    call(
      {
        url: "vehicle/default/vehicle-part-list",
        params: { vehicle: _vehicle_id },
        type: "POST",
      },
      function (resp) {
    ...
    $.each(data, function () {
      ...
      $.each(this.questions, function (i) {
        ...
        _html +=
          ...
          '</td>\
                        <td>\
                            <select class="form-control part-status" name="MapPartVehicleInspection[' +
          _id +
          "][" +
          _que_id +
          '][status]">\
                    ...
                    <tr class="defect-comment">\
                        <td colspan="2">\
                            <textarea class="form-control" name="MapPartVehicleInspection[' +
          _id +
          "][" +
          _que_id +
          '][defect_comment]" placeholder="Defect Comments" style="resize:none;"></textarea>\
                        </td>\
                    </tr>';
      });
    });
...
function getCode(kp, type) {
  call(
    {
      url: "admin/landowner/get-geo-code",
      params: { kp: kp, state: type, project: project },
      type: "POST",
    },
    function (resp) {
      if (resp.status) {
...
$(document).ready(function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (data.status) {
          ...
          toastr.error(data.message, messages.opps, {
            timeOut: 0,
            closeButton: !0,
          });
        }
      ...
      error: function () {
        $(".pjax-loader").hide();
        toastr.error(
          "Your server request has been failed,please try after sometime",
          "Request Failed!",
          { timeOut: 0, closeButton: !0 }
        );
      },
    });
  });
  ...
  $(document).on("click", ".map-picker-addon", function () {
    ...
    if ($(this).closest(".input-group").find("input").hasClass("geo-start")) {
      ...
      $(this).closest(".input-group").find("input").hasClass("geo-end")
    ) {
      current_origin = "end";
    }

    if (
      typeof _current_section != "undefined" &&
      (_current_section == "landowner" || _current_section == "line")
    ) {
  ...
  $(document).on("click", ".signed-selected", function (e) {
    ...
    if ($(".grid-view").yiiGridView("getSelectedRows") != "") {
      call(
        {
          url: Url,
          params: { signedId: $(".grid-view").yiiGridView("getSelectedRows") },
          type: "POST",
        },
        function (resp) {
  ...
  $(document).on("click", ".print-selected", function (e) {
    ...
    var Url = $(this).attr("url");
    call(
      { url: Url, params: { printid: "Yes", id: ids }, type: "POST" },
      function (resp) {
            ...
            call(
              {
                url: Url,
                params: {
                  deleteId: $(".grid-view").yiiGridView("getSelectedRows"),
                },
                type: "POST",
              },
              function (resp) {
  ...
  $(document).on("change", ".taxonomy-val", function (e) {
    ...
    if (_id == 2) {
      call(
        { url: "admin/taxonomy/projects", params: { id: 4 }, type: "POST" },
        function (resp) {
          html =
      ...
      call(
        {
          url: "admin/taxonomy/taxomonychild",
          params: { id: _id },
          type: "POST",
        },
        function (resp) {
          if (resp.status == true) {
            $.each(resp.data, function (key, value) {
              html +=
                '<div class="col-6"><div class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">\
							<input type="checkbox" name="TaxonomyValue[taxonomyChildId][]" class="custom-control-input" id="customcheckbox' +
                key +
                '" value="' +
                value.id +
                '">\
  ...
  $(document).on("blur", "#taxonomyvalue-value", function () {
    ...
    var edit_id =
      typeof getUrlParameter("EditId") != "undefined"
        ? getUrlParameter("EditId")
        : 0;
    var _this = $(this);
    if (typeof _taxonomy_val != "undefined" && _taxonomy_val == 30) {
      call(
        {
          url: "admin/taxonomy/unique-part-name",
          params: { name: _val, taxo: _taxonomy_val, edit: edit_id },
          type: "POST",
        },
        function (resp) {
          if (!resp.status) {
  ...
  $(document).on("change", ".taxonomy-val", function () {
    ...
    var edit_id =
      typeof getUrlParameter("EditId") != "undefined"
        ...
        : 0;
    if (
      typeof _taxonomy_val != "undefined" &&
      _taxonomy_val == 30 &&
      _val != ""
    ) {
      call(
  ...
  $(document).on("click", ".btn-clone-part-schedule", function () {
    ...
    call(
      { url: "vehicle/schedule/get-part", params: {}, type: "POST" },
      function (resp) {
        if (resp.status) {
  ...
  $(document).on("blur", ".vehicle-number", function () {
    ...
    if (typeof _number != "undefined" && _number != "") {
      call(
        {
          url: "vehicle/schedule/unique-vehicle-number",
          params: { number: _number, vehicle: _vehicle },
          type: "POST",
        },
        function (resp) {
          if (!resp.status) {
  ...
  $(document).on("blur", ".part-barcode", function () {
    if (!$(this).attr("readonly")) {
      ...
      if (typeof _code != "undefined" && _code != "") {
        call(
          {
            url: "vehicle/schedule/unique-part-barcode",
            params: { code: _code, part: _vehicle_part },
            type: "POST",
          },
          function (resp) {
            if (!resp.status) {
  ...
  $(document).on("blur", ".valid-vehi-number", function () {
    ...
    if (typeof _number != "undefined" && _number != "") {
      call(
        {
          url: "vehicle/default/check-availability",
  ...
  $("#basicSelect").change(function (event) {
    ...
    call(
      {
        url: "pipe/default/changeproject",
  ...
  $(document).on("change", "#langSelect", function (e) {
    ...
    call(
      { url: "site/change-lang", params: { lang: lang }, type: "POST" },
      function (resp) {
        if (resp.status) {
  ...
  $(document).on("change", ".location-drop", function () {
    ...
    call(
      {
        url: "pipe/pipe-cleargrade/location-geo-code",
        params: { id: _id, section: section },
        type: "POST",
      },
      function (resp) {
        if (resp.status && resp.geocode.lat != "" && resp.geocode.lat != "") {
          $(".geo-location-twice").val(
            resp.geocode.lat + " , " + resp.geocode.long
          );
  ...
  $(document).on("blur", ".kp-range", function () {
    ...
    if (_kp !== "") {
      call(
        {
          url: "pipe/stringing/kp-range",
          params: { kp: _kp, location: $("#stringing-location").val() },
          type: "POST",
        },
        function (resp) {
          if (!resp.status) {
  ...
  $(document).on("change", ".change-wps", function () {
    ...
    call(
      {
        url: "welding/welding/get-electrods",
        params: { wps: _current_val },
        type: "POST",
      },
      function (resp) {
        if (resp.status) {
    ...
    call(
      {
        url: "welding/welding/get-welders",
        params: { wps: _current_val },
        type: "POST",
      },
      function (resp) {
  ...
  $(document).on("blur", ".weld-number-check", function (e) {
    ...
    var _kp = $(".weld-kp").val();
    if (_kp == "") {
      toastr.error("KP can't be blank.", "Oops", {
        timeOut: 5000,
        closeButton: !0,
      });
      $(this).val("");
    ...
    call(
      {
        url: "welding/welding/weld-number-alert",
        params: { number: _number, kp: _kp },
        type: "POST",
      },
      function (resp) {
        if (!resp.status) {
          toastr.warning(
            "It will be saved in anomaly.",
            "Weld number has already taken.",
  ...
  $(document).on("change", ".weld-type", function () {
    ...
    if (_current_type != "W") {
      ...
      call(
        {
          url: "welding/welding/weld-crossing",
          params: { weld: _current_type, kp: _kp },
          type: "POST",
        },
        function (resp) {
          _html =
            '<div class="form-group field-welding-weld_crossing clearfix">\
                    <div class="col-md-6 col-sm-6 clearfix">\
                        ...
                        <input type="text" id="welding-weld_crossing" class="form-control weld-crossing-inp" name="Welding[weld_crossing]" value="' +
            parseInt(resp.count) +
            '">\
                    </div>\
                </div>';
  ...
  $(document).on("blur", ".weld-number-auto, .ndt-reject-weld", function () {
    ...
    var _type =
      typeof $(this).closest("form").attr("data-type") !== "undefined"
        ? $(this).closest("form").attr("data-type")
        : "";
    if (_type == "") {
      call(
        {
          url: "welding/parameter/get-weld-wps",
          params: { kp: _kp, number: _weld_number },
          type: "POST",
        },
        function (resp) {
          _html =
      ...
      _type == "ndt" ||
      _type == "production" ||
      _type == "coating_repair"
    ) {
      call(
        {
          url: "welding/default/get-weld-data",
          params: { number: _weld_number, kp: _kp },
          type: "POST",
        },
        function (resp) {
          var _weld_type =
  ...
  $(document).on("click", ".make-active", function () {
    ...
    if (Model.length != "" && Id != "") {
      call(
        {
          url: "admin/anomaly/active",
          params: { Id: Id, Model: Model },
          type: "GET",
        },
        function (resp) {
          if (resp.status == true) {
  ...
  $(document).on("change", "#change-welder", function () {
    ...
    window.location.href =
      baseurl + "/report/report/welder-detail?welder_name=" + _current_val;
  });
  ...
  $(document)
    .on("beforeSubmit", "form", function (e) {
      ...
      var submitForm = function (formData) {
        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            if (data.status) {
              if (
                typeof data.modelData != "undefined" &&
                typeof data.modelData.is_anomally != "undefined" &&
                data.modelData.is_anomally !== null &&
                data.modelData.is_anomally == "Yes"
              ) {
                toastr.warning(
                  data.modelData.why_anomally,
                  "Your data has been saved as anomaly",
                  { timeOut: 0, closeButton: !0 }
                );
              } else {
              ...
              $.pjax
                .reload({ container: "#idofpjaxcontainer" })
                .done(function () {
              ...
              if (jQuery.type(data.message) == "object") {
                ...
                if (jQuery.type(data.message) == "string") {
                  ...
                  toastr.error(JSON.stringify(data.message), "Oops!", {
                    timeOut: 0,
                    closeButton: !0,
                  });
                }
      ...
      if (formId == "slam-form") {
        ...
        call(
          {
            url: "report/safety/slam?EditId=" + EditId + "&isCheck=1",
        ...
        call(
          {
            url: "pipe/warning/pipe-warning?EditId=" + EditId,
            params: form.serialize(),
            type: "POST",
          },
          function (resp) {
              ...
              swal(
                {
                  ...
                  text:
                    resp.message +
                    " This record will be added to the anomaly list. Do you still wish to continue?",
                  type: "warning",
                  showCancelButton: true,
                  confirmButtonColor: "#DD6B55",
                  confirmButtonText: "Yes",
        ...
        call(
          {
            url: "pipe/warning/pipe-reception-warning?EditId=" + EditId,
            params: form.serialize(),
            type: "POST",
          },
          function (resp) {
        ...
        call(
          {
            url: "pipe/warning/pipe-transfer-warning?EditId=" + EditId,
            params: form.serialize(),
            type: "POST",
          },
          function (resp) {
        ...
        call(
          {
            url: "pipe/warning/pipe-stringing-warning?EditId=" + EditId,
            params: form.serialize(),
            type: "POST",
          },
          function (resp) {
        ...
        call(
          {
            url: "pipe/warning/pipe-cleargrade-warning?EditId=" + EditId,
            params: form.serialize(),
            type: "POST",
          },
          function (resp) {
        ...
        call(
          {
            url: "pipe/warning/pipe-bending-warning?EditId=" + EditId,
            params: form.serialize(),
            type: "POST",
          },
          function (resp) {
        ...
        if (EditId != 0) {
          call(
            {
              url: "pipe/warning/pipe-cutting-warning?EditId=" + EditId,
              params: form.serialize(),
              type: "POST",
            },
            function (resp) {
                      ...
                      swal(
                        {
                          title: "Warning",
                          text:
                            resp.message + " Do you still wish to continue?",
                          type: "warning",
                          showCancelButton: true,
                          confirmButtonColor: "#DD6B55",
                          confirmButtonText: "Yes",
        ...
        call(
          {
            url: "pipe/warning/welding-warning?EditId=" + EditId,
            params: form.serialize(),
            type: "POST",
          },
          function (resp) {
        ...
        call(
          {
            url: "pipe/warning/welding-parameter-warning?EditId=" + EditId,
            params: form.serialize(),
            type: "POST",
          },
          function (resp) {
        ...
        call(
          {
            url: "pipe/warning/welding-ndt-warning?EditId=" + EditId,
            params: form.serialize(),
            type: "POST",
          },
          function (resp) {
        ...
        call(
          {
            url: "pipe/warning/welding-weldrepair-warning?EditId=" + EditId,
            params: form.serialize(),
            type: "POST",
          },
          function (resp) {
        ...
        call(
          {
            url: "pipe/warning/welding-production-warning?EditId=" + EditId,
            params: form.serialize(),
            type: "POST",
          },
          function (resp) {
        ...
        call(
          {
            url: "pipe/warning/welding-coatingrepair-warning?EditId=" + EditId,
            params: form.serialize(),
            type: "POST",
          },
          function (resp) {
        ...
        call(
          {
            url: "pipe/warning/civil-trenching-warning?EditId=" + EditId,
            params: form.serialize(),
            type: "POST",
          },
          function (resp) {
        ...
        call(
          {
            url: "pipe/warning/civil-lowering-warning?EditId=" + EditId,
            params: form.serialize(),
            type: "POST",
          },
          function (resp) {
        ...
        call(
          {
            url: "pipe/warning/civil-backfilling-warning?EditId=" + EditId,
            params: form.serialize(),
            type: "POST",
          },
          function (resp) {
        ...
        call(
          {
            url: "pipe/warning/civil-reinstatement-warning?EditId=" + EditId,
            params: form.serialize(),
            type: "POST",
          },
          function (resp) {
        ...
        call(
          {
            url: "pipe/warning/precom-cleanguage-warning?EditId=" + EditId,
            params: form.serialize(),
            type: "POST",
          },
          function (resp) {
        ...
        call(
          {
            url: "pipe/warning/precom-hydrotesting-warning?EditId=" + EditId,
            params: form.serialize(),
            type: "POST",
          },
          function (resp) {
        ...
        call(
          {
            url: "pipe/warning/cable-warning?EditId=" + EditId,
            params: form.serialize(),
            type: "POST",
          },
          function (resp) {
        ...
        call(
          {
            url: "pipe/warning/cab-stringing-warning?EditId=" + EditId,
            params: form.serialize(),
            type: "POST",
          },
          function (resp) {
        ...
        call(
          {
            url: "pipe/warning/cab-splicing-warning?EditId=" + EditId,
            params: form.serialize(),
            type: "POST",
          },
          function (resp) {
        ...
        call(
          {
            url: "report/report/production?filter=true",
            params: form.serialize(),
            type: "POST",
          },
          function (resp) {
        ...
        call(
          {
            url: "report/report/welder-combine",
            params: form.serialize(),
            type: "POST",
          },
          function (resp) {
        ...
        $(".list-question").each(function () {
          if ($(this).val() == "") {
            toastr.error(
              "Please ensure all questions have been filled",
              "Oops!",
              { timeOut: 0, closeButton: !0 }
            );
            queflag = true;
        ...
        if ($(".vehicle-part").length > 0) {
          $(".vehicle-part").each(function () {
            if ($(this).val() == 0) {
              toastr.error(
                "Please ensure all parts have been selected.",
                "Oops!",
                { timeOut: 0, closeButton: !0 }
              );
              queflag = true;
          ...
          toastr.error(
            "Please select atleast one part to the vehicle.",
            "Oops!",
            { timeOut: 0, closeButton: !0 }
          );
          queflag = true;
        ...
        if (_dropdown_array_duplicate.length > 0) {
          toastr.error(
            "There are some duplicate parts found. Please make them unique.",
            "Oops!",
            { timeOut: 0, closeButton: !0 }
          );
          queflag = true;
  ...
  $(document).on("change", ".pull-kp", function (e) {
    var kp = $(this).val();
    call(
      { url: "welding/default/get-geo-code", params: { kp: kp }, type: "GET" },
      function (resp) {
  ...
  $(document).on("click", ".make-sequence", function (e) {
    ...
    var _this = $(this);
    _this.attr("disabled", true);
    $('.sequence_load').addClass('lds-ring');
    $('.sequence_span').css("padding-left", "30px");
    call(
      { url: "report/report/sequence", params: {}, type: "GET" },
      function (resp) {
        _this.attr("disabled", false);
        if (resp) {
          toastr.success("Sequence successfully done.", "Success!");
          $('.sequence_load').removeClass('lds-ring');
          $('.sequence_span').css("padding-left", "0px");
          setTimeout(function () {
            location.reload();
          }, 1500);
        }
  ...
  $(document).on("focusout", ".duplicate-cutting-check", function (e) {
    ...
    if (_number !== "") {
      call(
        {
          url: "pipe/cutting/check-duplicate-cut",
          params: { number: _number },
          type: "POST",
        },
        function (resp) {
          if (resp.status) {
            toastr.warning(
              ...
              "The pipe number has already been cut.",
              { timeOut: 5000, closeButton: !0 }
            );
          }
        }
  ...
  $(document).on("blur", ".cr-pipe-defect", function (e) {
    ...
    if (_number !== "") {
      call(
        {
          url: "welding/coatingrepair/check-valid-pipe",
          params: { number: _number },
          type: "POST",
        },
        function (resp) {
          if (!resp.status) {
            _this.val("");
            toastr.error(
              "Pipe number is not available in Pipe List. Please enter a valid pipe number!",
              "Oops!",
            ...
            call(
              {
                url: "welding/coatingrepair/get-pipe-defects",
                params: { number: _number },
                type: "POST",
              },
              function (resp) {
                if (resp.status) {
                  ...
                  if (resp.data.length > 0) {
                    ...
                    _html +=
                      '<li class="list-group-item">No defects found.</li>';
                  }
  ...
  $(document).on("focusout", ".coatingrepair-weld", function (e) {
    ...
    if (_weld !== "" && _kp !== "") {
      call(
        {
          url: "welding/coatingrepair/check-valid-weld",
          params: { weld: _weld, kp: _kp },
          type: "POST",
        },
        function (resp) {
          if (!resp.status) {
            _this.val("");
            toastr.error(
              "Weld number is not available in Welding. Please enter a valid weld number!",
              "Oops!",
              { timeOut: 3000, closeButton: !0 }
            );
          }
