...
$model->fill1_os = !empty($lastWeldData['fill1_os']) ? $lastWeldData['fill1_os'] : ''; 
$model->fill1_ts = !empty($lastWeldData['fill1_ts']) ? $lastWeldData['fill1_ts'] : ''; 
$model->fill2_os = !empty($lastWeldData['fill2_os']) ? $lastWeldData['fill2_os'] : ''; 
$model->fill2_ts = !empty($lastWeldData['fill2_ts']) ? $lastWeldData['fill2_ts'] : ''; 
$model->fill3_os = !empty($lastWeldData['fill3_os']) ? $lastWeldData['fill3_os'] : ''; 
$model->fill3_ts = !empty($lastWeldData['fill3_ts']) ? $lastWeldData['fill3_ts'] : ''; 
    ...
    <div class="col-xl-5 col-lg-12 col-12 p-r-5">
        <div class="card-body card"> 
           ...
           ?>      
            ...
            <?= $form->field($model, 'fill1_os')->dropDownList($welderList, ['prompt'=>'', 'class'=>'form-control list-welders','disabled'=>Yii::$app->general->isAllowed()]); ?>
            <?= $form->field($model, 'fill1_ts')->dropDownList($welderList, ['prompt'=>'', 'class'=>'form-control list-welders','disabled'=>Yii::$app->general->isAllowed()]); ?>
            <?= $form->field($model, 'fill2_os')->dropDownList($welderList, ['prompt'=>'', 'class'=>'form-control list-welders','disabled'=>Yii::$app->general->isAllowed()]); ?>
            <?= $form->field($model, 'fill2_ts')->dropDownList($welderList, ['prompt'=>'', 'class'=>'form-control list-welders','disabled'=>Yii::$app->general->isAllowed()]); ?>
            <?= $form->field($model, 'fill3_os')->dropDownList($welderList, ['prompt'=>'', 'class'=>'form-control list-welders','disabled'=>Yii::$app->general->isAllowed()]); ?>
            <?= $form->field($model, 'fill3_ts')->dropDownList($welderList, ['prompt'=>'', 'class'=>'form-control list-welders','disabled'=>Yii::$app->general->isAllowed()]); ?>
