...
function getWeldingData($start,$end){
    ...
    $Welding = \app\models\Welding::find()->select(['welding.root_os','welding.root_ts','welding.hot_os','welding.hot_ts','welding.fill1_os','welding.fill1_ts','welding.fill2_os','welding.fill2_ts','welding.fill3_os','welding.fill3_ts','welding.cap_os','welding.cap_ts','pipe.od'])
