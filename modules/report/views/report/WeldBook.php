			...
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-form"><?= Yii::$app->trans->getTrans('Weld Book'); ?>
						...
						<button type="button" class="btn btn-success pull-right make-sequence d-inline">
							<div class="sequence_load"><div></div><div></div><div></div><div></div></div>
							<span class="sequence_span" style="padding-left: 0px;"><?= Yii::$app->trans->getTrans('Sequence Manually'); ?></span>
						</button>
				...
				<div class="card-body">
					...
					<?= GridView::widget([
						...
						'columns' => [
							...
							'pipe_number',
							[
								'attribute' => 'pipe_bend_angle',
								'label' => 'Bend Angle',
								'filter' => false,
								'value' => function ($model) {
									$PipeBend = \app\models\Bending::find()->select(['angle'])->where(['pipe_number' => $model->pipe_number])->active()->asArray()->one();
									return !empty($PipeBend['angle']) ? $PipeBend['angle'] : '-';
								},
							],
							'next_pipe',
							[
								'attribute' => 'next_pipe_bend_angle',
								'label' => 'Bend Angle',
								'filter' => false,
								'value' => function ($model) {
									$PipeBend = \app\models\Bending::find()->select(['angle'])->where(['pipe_number' => $model->next_pipe])->active()->asArray()->one();
									return !empty($PipeBend['angle']) ? $PipeBend['angle'] : '-';
								},
							],
							[
								'attribute' => 'next_pipe_yield_strength',
								'label' => 'Yield Strength',
								'filter' => false,
								'value' => function ($model) {
									$Pipe = \app\models\Pipe::find()->select(['yeild_strength'])->where(['pipe_number' => $model->next_pipe])->active()->asArray()->one();
									return !empty($Pipe['yeild_strength']) ? $Pipe['yeild_strength'] : '-';
								},
							],
							'sequence',
							[
							...
							[
								...
								'filter' => false,
								'value' => function ($model) {
									return !empty($model->fill1_os) ? $model->fill1_os : "-";
								},
							],
							[
								'attribute' => 'fill1_ts',
								...
								'filter' => false,
								'value' => function ($model) {
									return !empty($model->fill1_ts) ? $model->fill1_ts : "-";
								},
							],
							[
								'attribute' => 'fill2_os',
								...
								'filter' => false,
								'value' => function ($model) {
									return !empty($model->fill2_os) ? $model->fill2_os : "-";
								},
							],
							[
								'attribute' => 'fill2_ts',
								...
								'filter' => false,
								'value' => function ($model) {
									return !empty($model->fill2_ts) ? $model->fill2_ts : "-";
								},
							],
							[
								'attribute' => 'fill3_os',
								...
								'filter' => false,
								'value' => function ($model) {
									return !empty($model->fill3_os) ? $model->fill3_os : "-";
								},
							],
							[
								'attribute' => 'fill3_ts',
								...
								'filter' => false,
								'value' => function ($model) {
									return !empty($model->fill3_ts) ? $model->fill3_ts : "-";
								},
							],
							[
								'attribute' => 'cap_os',
