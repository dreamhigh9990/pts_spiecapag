 ...
 * @property string $fill1_os
 * @property string $fill1_ts
 * @property string $fill2_os
 * @property string $fill2_ts
 * @property string $fill3_os
 * @property string $fill3_ts
...
class Welding extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['kp', 'line_type', 'visual_acceptance', 'signed_off', 'is_anomally', 'has_been_cut_out'], 'string'],
            [['weld_number'], 'number'],
            ...
            // }],
            [['report_number', 'pipe_number', 'next_pipe', 'geo_location', 'weld_type', 'weld_number', 'weld_sub_type', 'WPS', 'root_os', 'root_ts', 'hot_os', 'hot_ts', 'fill1_os', 'fill1_ts', 'fill2_os', 'fill2_ts', 'fill3_os', 'fill3_ts', 'cap_os', 'cap_ts', 'comment','why_anomally'], 'string', 'max' => 255],
    ...
    public function print_attributes(){
        return [          
            ...
            'fill1_os' => Yii::$app->trans->getTrans('Fill1 Os'),
            'fill1_ts' => Yii::$app->trans->getTrans('Fill1 Ts'),
            'fill2_os' => Yii::$app->trans->getTrans('Fill2 Os'),
            'fill2_ts' => Yii::$app->trans->getTrans('Fill2 Ts'),
            'fill3_os' => Yii::$app->trans->getTrans('Fill3 Os'),
            'fill3_ts' => Yii::$app->trans->getTrans('Fill3 Ts'),
