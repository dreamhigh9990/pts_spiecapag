...
class Production extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['dew_point', 'temperature', 'substrate_temprature', 'humidity', 'surface_profile', 'dft', 'dft_2', 'dft_3', 'dft_4', 'dft_5', 'dft_6', 'salt_testing'], 'number'],
            // ['kp','match','pattern'=>'/^[a-z,A-Z]-(\d)+$/', 'message'=>'You must input the value to keep format. ex:A-0 '],
            [['kp', 'abrasive_material', 'comment', 'signed_off', 'is_anomally', 'batch_number_a', 'batch_number_b'], 'string'],
