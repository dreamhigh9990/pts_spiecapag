...
class BendingSearch extends Bending
{
    ...
    public function search($params)
    {
        ...
        if(Yii::$app->controller->module->id == "admin" && Yii::$app->controller->id == "anomaly"){
            $query = Bending::find()->anomally()->orderBy($this->sortOption($params,'id DESC'));
        }else{
             $query = Bending::find()->active()->orderBy($this->sortOption($params,'id DESC'));
        }
        ...
        if ($this->download) {
            ...
            Yii::$app->export->excelExport('bending', $dataProvider->query->all());
        }
